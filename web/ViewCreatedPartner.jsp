<%-- 
    Document   : ViewCreatedPartner
    Created on : 02-05-2015, 11:53:32
    Author     : Jeanette
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
<%@page import="control.PartnerDTO"%>
<%PartnerDTO partner = (PartnerDTO) request.getAttribute("partner");%>
<!DOCTYPE html>
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>View created partner</title><h5 align="right">Username:&nbsp ${user.getFirstname()} </h5>
...
<body>
    ...
    <hr>
    <br>
    <h4>Partner ID: <%=partner.getPartnerID()%></h4>
    <br>
    <h4>Country: <%=partner.getCountry()%></h4>
    <br>
    <h4>Partner Name: <%=partner.getPartnerName()%></h4>
    <br>
    <h4>Partner type: <%=partner.getPartnerType()%></h4>
    <br>
</body>
</html>