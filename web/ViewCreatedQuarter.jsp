<%-- 
    Document   : ViewCreatedQuarter
    Created on : 02-05-2015, 11:48:25
    Author     : Jeanette
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
<%@page import="control.QuarterDTO"%>
<%QuarterDTO quarter = (QuarterDTO) request.getAttribute("quarter");%>
<!DOCTYPE html>
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>View created quarter</title><h5 align="right">Username:&nbsp ${user.getFirstname()} </h5>
...
<body>
    ...
    <hr>
    <br>
    <h4>Quarter name: <%=quarter.getQuarterName()%></h4>
    <br>
    <h4>Quarter budget: <%=quarter.getQuarterBudget()%></h4>
    <br>
</body>
</html>